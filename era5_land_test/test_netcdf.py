#!/usr/bin/env python3
"""
Test script to check NetCDF file reading
"""
...
def test_netcdf_reading():
    """Test if the NetCDF file can be read"""
...
if __name__ == "__main__":
    print("=== NetCDF File Reading Test ===\n")
    ...
    if success:
        ...
        print("ds = xr.open_dataset('era5_land_hourly_202401.nc')")
        print("```")
    else:
